...
const currencyToNumber = (value) =>
  parseFloat(("" + value).substring(4, value.length));
...
const loadBalance = () => {
  ...
  //atualizar o DOM
  document.querySelector("#balance").textContent = stringToCurrency(
    formData.total
  );
